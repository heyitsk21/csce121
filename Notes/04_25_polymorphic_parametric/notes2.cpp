...
class SubObject : public Object {
 ...
 public:
    ...
    SubObject(const Object& o) : Object(o.get_x()) {}
};
...
int main() {
    ...
    LinkedList<Quaternion> Quaternion_list;
    LinkedList<LinkedList<Object>> Object_list_list;

    int_list.insert(0,1);
    Quaternion_list.insert(0,Quaternion(1,2,3,4));
    LinkedList<Object> Object_list;
    Object_list.insert(0, Object(1));
    Object_list_list.insert(0, Object_list);

    debug(int_list.at(0));
    debug(Quaternion_list.at(0));
    debug(Object_list.at(0));
    debug(Object_list_list.at(0).at(0));
